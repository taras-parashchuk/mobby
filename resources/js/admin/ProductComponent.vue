<template>
    <div class="table-list-container" v-if="Object.keys(product).length">
        ...
        <div class="singleForm">
            <div class="singleFormHeader "
            :class="{'singleFormHeader--fixed' : $root.scroll_info < -60}">
                <h2 v-if="$root.scroll_info < -60" class="mainContent__heading mainContent__heading--inProduct">
                            {{product.translates.find(translate => {return translate.locale ==
                            $root.adminLanguage}).name}}</h2>
                <div class="tabs">
                        ...
                        <div>
                            <template v-if="product.type !== 2">
                                <div class="singleFormGroup">
                                    ...
                                    <div class="singleFormGroup__field inputWithTranslates"
                                         v-for="translate in product.translates">
                                        <div class="flex flex--align-center">
                                ...
                                <div class="singleFormGroup__field">
                                    <div class="flex flex--align-center">
                                        <v-select
                                                :clearable="true"
                                                :searchable="true"
                                                :options="product.suppliers.map(supplier => supplier.supplier_code)"
                                                v-model="product.price_source"
                            ...
                            <div class="singleFormGroup singleFormGroup--inlineSet">
                                    ...
                                    <div class="singleFormGroup__field">
                                        <div class="flex flex--align-center">
                                            <input type="text" class="input input--price_inProduct"
                                                   v-model.number="product.warehouse_price">
                                        </div>
                                    </div>
                                </div>
                                <div class="singleFormGroup__set">
                                    ...
                                    <div class="singleFormGroup__field">
                                        <div class="flex flex--align-center">
                                            <input type="text" disabled class="input input--price_inProduct"
                                        ...
                                        <div class="singleFormGroup__field">
                                            <div class="flex flex--align-center">
                                                <input type="number" class="input input--inForm"
                                                       v-model.number="product.warehouse_quantity">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="singleFormGroup" v-if="product.type !== 2">
                                ...
                                <div class="singleFormGroup__field inputWithTranslates"
                                    ...
                                    <div class="flex">
                                        ...
                                        <vue-ckeditor v-if="render_finished"
                            ...
                            <div class="singleFormGroup">
                                ...
                                <div class="singleFormGroup__field">
                                    <div class="flex flex--align-center">
                                        <div class="switcherStatus">
                                            <div @click="product.is_zamanyha = false" class="switcherStatus__value"
                                                 :class="{'switcherStatus__value--active switcherStatus__value--active_off': product.is_zamanyha === false}">
                                                {{$root.translate.columns.no}}
                                            </div>
                                            <div @click="product.is_zamanyha = true" class="switcherStatus__value"
                                                 :class="{'switcherStatus__value--active': product.is_zamanyha === true}">
                    ...
                    <div class="singleFormGroup">
                        ...
                        <div class="singleFormGroup__field">
                            ...
                            <div class="flex flex--align-center searchResultsItem searchResultsItem--related"
                                ...
                                <div>
                                    <icon @click.native.stop="product.relateds.splice(rel_index, 1)" icon="delete"
                            ...
                            <div class="singleFormGroup__field">
                                <div class="flex flex--align-center">
                                    <v-select
                                            ...
                                            class="input input--inForm"
                                            :reduce="category => category.id"
                                            @input="getCategoryFilteredAttributes"
                                            label="name">
                                        <div slot="no-options">{{$root.translateWords('Data not found')}}</div>
                                    </v-select>
                                </div>
                            ...
                            <template slot="table-row" slot-scope="props">
                                ...
                                <template v-else-if="props.column.field === 'action'">
                                    <a v-tooltip.top-start="'You have new messages.'" class="table__action"
                                       ...
                                       @click.stop="deleteProductParameters('specials',props.index)">
                                        <icon icon="delete" class="icon"></icon>
                                    </a>
                                </template>
                            </template>
                        ...
                        <vue-good-table
                            ...
                            <template slot="table-row" slot-scope="props">
                                ...
                                <template v-else-if="props.column.field === 'action'">
                                    <a v-tooltip.top-start="'You have new messages.'" class="table__action"
                                       href="javascript:void(0)"
                                       @click.stop="deleteProductParameters('discounts',props.index)">
                                        <icon icon="delete" class="icon"></icon>
                                    </a>
                                </template>
                            </template>
...
<script>
        ...
        methods: {
                ...
                if (this.product.type === 2 && !this.product.variants.length) {
                    ...
                    axios.put('/admin/products/' + this.product.id, this.product).then(
                        httpResponse => {
                            ...
                            this.product.vendor_price = httpResponse.data.vendor_price;
                            this.product.quantity = httpResponse.data.quantity;
                            ...
                            this.$set(this, 'savedOriginal', this.$root.copy(this.product));
                            this.$set(this, "actionProduct", { type: "save",
                                                               name: this.product.translates,
                                                               price: this.product.vendor_price,
                                                               quantity: this.product.quantity,
                                                               id: this.product.id,
                                                               visual_labels: this.product.visual_labels,
                                                               date_available_day: this.product.date_available_day
                                                             }
                            );
                            if (this.product.images.length === 0) {
                                this.actionProduct.img_thumb = null;
                                this.actionProduct.img = null;
                            }else{
                                this.actionProduct.img_thumb = this.product.images[0].filemanager_thumb;
                                this.actionProduct.img = this.product.images[0].src;
                            }
                        }).catch(error => {
                        if (error.response) this.$root.notify(error.response.data);
                    }).finally(() => {
            ...
            getProducts: _.debounce((phrase, self, loading) => {
                axios.get('/admin/products', {
                    ...
                    httpResponse => {
                        self.products = httpResponse.data;
                        //if (loading !== null)
                        loading(false);
                    }
                )
            ...
            getCategoryFilteredAttributes(category_id) {
                if (category_id) {
                    axios.get(`/admin/filter/category/${category_id}`).then(httpResponse => {
                        let category_attributes = httpResponse.data;

                        category_attributes.forEach(category_attribute => {
                           if(!this.product.to_attributes.find(to_attribute => {
                               return to_attribute.attribute.id === category_attribute.attribute_id;
                           })){
                               this.product.to_attributes.unshift({
                                   id: 'tmp-' + Math.random(100000, 10000000),
                                   attribute: {
                                       id: category_attribute.attribute_id,
                                       name: category_attribute.attribute.translate.name
                                   },
                                   values: [],
                                   main: false,
                                   has_variant: false
    ...
    beforeRouteLeave (to, from, next) {
        if (this.actionProduct) {
            ...
            //to.params.status = true;
            to.params.product = {id: this.product.id};
        }
