                    ...
                    <div class="singleFormGroup__field">
                        <div class="flex flex--align-center">
                            <v-select
                                    ...
                                    :searchable="false"
                                    :options="designs"
                                    v-model="module.decoded_setting.design_type"
                                    class="input input--inForm"
                                    :reduce="design => design.value"
                                    label="value">
                                <template slot="selected-option" slot-scope="option">
                                    {{ option.text }}
                                </template>
        ...
        data() {
            return {
                ...
                designs: [
                    {
                        value: 1,
                        text: this.$root.translate.columns.design + ' - 1'
                    },
                    {
                        value: 2,
                        text: this.$root.translate.columns.design + ' - 2'
                    }
                ]
            }
        },
